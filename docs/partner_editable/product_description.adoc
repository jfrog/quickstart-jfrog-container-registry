...
Once you deploy JFrog’s Container Registry, you can use it as a production service. For further information about setting up Container Registry, see the <<#_get_started_with_container_registry, Get started with Container Registry>> section, later in this guide.
